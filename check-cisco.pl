...
# Credit goes to rnal @ https://github.com/ranl/monitor-utils/blob/master/nagios/check-cisco.pl
# I have only modified some items to work better or differet for some users
